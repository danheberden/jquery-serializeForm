...
(function(a){a.fn.serializeObject=function(){if(!this.length)return!1;var b=this,c={},d=c;return b.find(':input[type!="checkbox"][type!="radio"], input:checked').each(function(){var b=this.name.replace(/\[([^\]]+)?\]/g,",$1").split(","),e=b.length-1,f=0;if(b[0]){for(;f<e;f++)d=d[b[f]]=d[b[f]]||(b[f+1]==""?[]:{});d.length!=undefined?d.push(a(this).val()):d[b[e]]=a(this).val(),d=c}}),c}})(jQuery);